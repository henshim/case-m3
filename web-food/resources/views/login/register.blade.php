...
<head>
    ...
    <link href="{{ asset('template-admin/assets/css/nucleo-svg.css') }}" rel="stylesheet"/>
    <!-- CSS Files -->
    <link id="pagestyle" href="{{ asset('template-admin/assets/css/soft-ui-dashboard.css?v=1.0.3') }}"
          rel="stylesheet"/>
</head>
...
<nav class="navbar navbar-expand-lg position-absolute top-0 z-index-3 w-100 shadow-none my-3  navbar-transparent mt-4">
    <div class="container">
        <a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 text-white"
           href="{{ asset('template-admin/pages/dashboards/default.html') }}">
            Soft UI Dashboard
        </a>
                ...
                <li class="nav-item dropdown dropdown-hover mx-2">
                    <a role="button"
                       ...
                       id="dropdownMenuPages" data-bs-toggle="dropdown" aria-expanded="false">
                        Pages
                        <img src=" {{ asset('template-admin/assets/img/down-arrow-dark.svg') }}" alt="down-arrow"
                            ...
                            <div class="col-12 px-4 py-2">
                                <div class="row">
                                    <div class="col-4 position-relative">
                                        ...
                                        <a href="{{ asset('template-admin/pages/dashboards/default.html') }}"
                                           class="dropdown-item border-radius-md">
                                            <span class="ps-3">Default</span>
                                        </a>
                                        <a href="{{ asset('template-admin/pages/dashboards/automotive.html') }}"
                                           class="dropdown-item border-radius-md">
                                            <span class="ps-3">Automotive</span>
                                        </a>
                                        <a href="{{ asset('template-admin/pages/dashboards/smart-home.html') }}"
                                           class="dropdown-item border-radius-md">
                                            <span class="ps-3">Smart Home</span>
                                        </a>
                                        <a href="{{ asset('template-admin/pages/dashboards/virtual-reality.html') }}"
                                           class="dropdown-item border-radius-md">
                                            <span class="ps-3">Virtual Reality</span>
                                        </a>
                                        <a href="{{ asset('template-admin/pages/dashboards/crm.html') }}"
                                           class="dropdown-item border-radius-md">
                                        ...
                                        <a href="{{ asset('template-admin/pages/pages/users/reports.html') }}"
                                           class="dropdown-item border-radius-md">
                                            <span class="ps-3">Reports</span>
                                        </a>
                                        <a href="{{ asset('template-admin/pages/pages/users/new-user.html') }}"
                                           class="dropdown-item border-radius-md">
                                    ...
                                    <div class="col-4 position-relative">
                                        ...
                                        <a href="{{ asset('template-admin/pages/pages/profile/overview.html') }}"
                                           class="dropdown-item border-radius-md">
                                            <span class="ps-3">Overview</span>
                                        </a>
                                        <a href="{{ asset('template-admin/pages/pages/profile/teams.html') }}"
                                           class="dropdown-item border-radius-md">
                                            <span class="ps-3">Teams</span>
                                        </a>
                                        <a href="{{ asset('template-admin/pages/pages/profile/projects.html') }}"
                                           class="dropdown-item border-radius-md">
                                        ...
                                        <a href="{{ asset('template-admin/pages/pages/projects/general.html') }}"
                                           class="dropdown-item border-radius-md">
                                            <span class="ps-3">General</span>
                                        </a>
                                        <a href="{{ asset('template-admin//pages/pages/projects/timeline.html') }}"
                                           class="dropdown-item border-radius-md">
                                            <span class="ps-3">Timeline</span>
                                        </a>
                                        <a href="{{ asset('template-admin/pages/pages/projects/new-project.html') }}"
                                           class="dropdown-item border-radius-md">
                                    ...
                                    <div class="col-4">
                                        ...
                                        <a href="{{ asset('template-admin/pages/pages/account/settings.html') }}"
                                           class="dropdown-item border-radius-md">
                                            <span class="ps-3">Settings</span>
                                        </a>
                                        <a href="{{ asset('template-admin/pages/pages/account/billing.html') }}"
                                           class="dropdown-item border-radius-md">
                                            <span class="ps-3">Billing</span>
                                        </a>
                                        <a href="{{ asset('template-admin/pages/pages/account/invoice.html') }}"
                                           class="dropdown-item border-radius-md">
                                            <span class="ps-3">Invoice</span>
                                        </a>
                                        <a href="{{ asset('template-admin/pages/pages/account/security.html') }}"
                                           class="dropdown-item border-radius-md">
                                ...
                                <ul class="list-group">
                                    <li class="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                                        <a class="dropdown-item border-radius-md ps-3 d-flex align-items-center justify-content-between mb-1"
                                           id="dropdownSignIn">
                                            <span>Sign In</span>
                                            <img src="{{ asset('template-admin/assets/img/down-arrow.svg') }}"
